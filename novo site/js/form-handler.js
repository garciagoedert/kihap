...
document.addEventListener('ctaLoaded', () => {
    initFormHandler();
});
...
function initFormHandler() {
    if (formInitialized && document.getElementById('lead-form')) return; // Avoid double initialization if already found
    ...
    if (leadForm) {
        ...
        // Remove listener if already exists (safeguard)
...
// Lógica do Form de Academy que já está na DOM, então pode ficar fora ou dentro do init
// Vamos deixar onde está, mas garantir que attach na DOM
