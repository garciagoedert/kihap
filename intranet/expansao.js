...
export function setupExpansaoPage() {
    onAuthReady(async (user) => {
        ...
        if (!isAdmin) {
            showAlert('Acesso restrito. Apenas administradores têm permissão para acessar a aba Expansão.', 'Acesso Negado');
...
export const setupAberturaUnidadesPage = setupExpansaoPage;
...
async function loadUnitsList() {
    ...
    try {
        ...
        console.error("Erro ao carregar unidades de expansão:", err);
